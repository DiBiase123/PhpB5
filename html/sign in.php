...
<head>
    ...
    <title>Inscription Char-ID</title>
    ...
    <div class="container-flex text-center sfondo">
        <div class="row justify-content-center align-items-center">
            <?php include_once('../php/titolo_sito.php'); ?>
                            <!-- +++ FORMULARIO +++ -->
                                <form method="POST" action="../php/signin_script.php" > 
                                    <legend><strong><b> Bienvenue !<br>
                                       Creéz votre compte: </b></strong>
                                    </legend>

                                    <div class="col">
                                    <input type="text" name="full_name" placeholder="Nom & Prénom" maxlength="50" 
                                                required autocorrect="off" spellcheck="false" class="mb-3 mt-3" />
                                        <br>
                                        <input type="text" name="email" placeholder="E-mail ou n° de téléphone" maxlength="50" 
                                                required autocorrect="off" spellcheck="false" class="mb-3 mt-3" />
                                        <br>
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-success bg-gradient border boder-1 mt-3 mb-3"> Sign In</button>                
                                        <br>
